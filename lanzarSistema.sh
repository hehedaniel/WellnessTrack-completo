...
sudo docker run -d --name backXampp -p 8080:80 -p 8081:3306 -p 8000:8000 --ip 172.79.0.3 --networ redApi -v ./WellnessTrack-api:/home/docker --entrypoint /bin/sh hehedaniel/backcompleto:backfinal -c "/opt/lampp/lampp start && cd /home/docker/Wellnesstrack-api && symfony server:start --port=8000"
